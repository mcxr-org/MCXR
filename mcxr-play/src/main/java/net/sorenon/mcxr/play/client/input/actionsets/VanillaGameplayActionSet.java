...
import net.sorenon.mcxr.play.client.input.actions.BoolAction;
import net.sorenon.mcxr.play.client.input.actions.FloatAction;
import net.sorenon.mcxr.play.client.input.actions.Vec2fAction;
