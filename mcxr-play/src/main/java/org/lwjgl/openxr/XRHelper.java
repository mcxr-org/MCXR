...
import static org.lwjgl.opengl.GLX13.glXGetCurrentDrawable;
    ...
    public static Struct createGraphicsBindingOpenGL(MemoryStack stack, long window) throws IllegalStateException {
        switch (Platform.get()) {
            case LINUX:
                 ...
                 */
                if (supportsX11) {
                    XrGraphicsBindingOpenGLXlibKHR graphicsBinding = XrGraphicsBindingOpenGLXlibKHR.malloc(stack);
                    ...
                    XrGraphicsBindingOpenGLWaylandKHR graphicsBinding = XrGraphicsBindingOpenGLWaylandKHR.malloc(stack);
                    graphicsBinding.set(
            ...
            case WINDOWS:
                XrGraphicsBindingOpenGLWin32KHR winGraphicsBinding = XrGraphicsBindingOpenGLWin32KHR.malloc(stack);
