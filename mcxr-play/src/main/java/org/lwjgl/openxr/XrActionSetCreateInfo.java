...
import static org.lwjgl.openxr.XR10.XR_MAX_ACTION_SET_NAME_SIZE;
import static org.lwjgl.openxr.XR10.XR_MAX_LOCALIZED_ACTION_SET_NAME_SIZE;
...
public class XrActionSetCreateInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrActionSetCreateInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrActionSetCreateInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_ACTION_SET_CREATE_INFO TYPE_ACTION_SET_CREATE_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_ACTION_SET_CREATE_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrActionSetCreateInfo.nnext(address(), value); return this; }
        /** Copies the specified encoded string to the {@code actionSetName} field. */
        public Buffer actionSetName(@NativeType("char[XR_MAX_ACTION_SET_NAME_SIZE]") ByteBuffer value) { XrActionSetCreateInfo.nactionSetName(address(), value); return this; }
        /** Copies the specified encoded string to the {@code localizedActionSetName} field. */
        public Buffer localizedActionSetName(@NativeType("char[XR_MAX_LOCALIZED_ACTION_SET_NAME_SIZE]") ByteBuffer value) { XrActionSetCreateInfo.nlocalizedActionSetName(address(), value); return this; }
        /** Sets the specified value to the {@code priority} field. */
        public Buffer priority(@NativeType("uint32_t") int value) { XrActionSetCreateInfo.npriority(address(), value); return this; }
