...
public class XrActionStateGetInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrActionStateGetInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrActionStateGetInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_ACTION_STATE_GET_INFO TYPE_ACTION_STATE_GET_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_ACTION_STATE_GET_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrActionStateGetInfo.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code action} field. */
        public Buffer action(XrAction value) { XrActionStateGetInfo.naction(address(), value); return this; }
        /** Sets the specified value to the {@code subactionPath} field. */
        public Buffer subactionPath(@NativeType("XrPath") long value) { XrActionStateGetInfo.nsubactionPath(address(), value); return this; }
