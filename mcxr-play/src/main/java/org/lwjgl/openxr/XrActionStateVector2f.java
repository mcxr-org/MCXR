...
public class XrActionStateVector2f extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrActionStateVector2f, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link XrVector2f} to the {@code currentState} field. */
        public Buffer currentState(XrVector2f value) { XrActionStateVector2f.ncurrentState(address(), value); return this; }
        /** Passes the {@code currentState} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer currentState(java.util.function.Consumer<XrVector2f> consumer) { consumer.accept(currentState()); return this; }
        /** Sets the specified value to the {@code changedSinceLastSync} field. */
        public Buffer changedSinceLastSync(@NativeType("XrBool32") boolean value) { XrActionStateVector2f.nchangedSinceLastSync(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@code lastChangeTime} field. */
        public Buffer lastChangeTime(@NativeType("XrTime") long value) { XrActionStateVector2f.nlastChangeTime(address(), value); return this; }
        /** Sets the specified value to the {@code isActive} field. */
        public Buffer isActive(@NativeType("XrBool32") boolean value) { XrActionStateVector2f.nisActive(address(), value ? 1 : 0); return this; }
