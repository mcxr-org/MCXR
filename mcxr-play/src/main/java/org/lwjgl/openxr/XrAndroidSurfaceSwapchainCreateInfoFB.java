...
public class XrAndroidSurfaceSwapchainCreateInfoFB extends Struct implements NativeResource {
    ...
    /** Sets the {@link FBAndroidSurfaceSwapchainCreate#XR_TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB} value to the {@code type} field. */
    public XrAndroidSurfaceSwapchainCreateInfoFB type$Default() { return type(FBAndroidSurfaceSwapchainCreate.XR_TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB); }
     ...
     */
    public static XrAndroidSurfaceSwapchainCreateInfoFB malloc(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrAndroidSurfaceSwapchainCreateInfoFB calloc(MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<XrAndroidSurfaceSwapchainCreateInfoFB, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrAndroidSurfaceSwapchainCreateInfoFB.ntype(address(), value); return this; }
        /** Sets the {@link FBAndroidSurfaceSwapchainCreate#XR_TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB} value to the {@code type} field. */
        public Buffer type$Default() { return type(FBAndroidSurfaceSwapchainCreate.XR_TYPE_ANDROID_SURFACE_SWAPCHAIN_CREATE_INFO_FB); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrAndroidSurfaceSwapchainCreateInfoFB.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code createFlags} field. */
        public Buffer createFlags(@NativeType("XrAndroidSurfaceSwapchainFlagsFB") long value) { XrAndroidSurfaceSwapchainCreateInfoFB.ncreateFlags(address(), value); return this; }
