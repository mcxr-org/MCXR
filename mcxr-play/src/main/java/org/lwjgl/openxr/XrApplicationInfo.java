...
public class XrApplicationInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrApplicationInfo, Buffer> implements NativeResource {
        ...
        /** Copies the specified encoded string to the {@code applicationName} field. */
        public Buffer applicationName(@NativeType("char[XR_MAX_APPLICATION_NAME_SIZE]") ByteBuffer value) { XrApplicationInfo.napplicationName(address(), value); return this; }
        /** Sets the specified value to the {@code applicationVersion} field. */
        public Buffer applicationVersion(@NativeType("uint32_t") int value) { XrApplicationInfo.napplicationVersion(address(), value); return this; }
        /** Copies the specified encoded string to the {@code engineName} field. */
        public Buffer engineName(@NativeType("char[XR_MAX_ENGINE_NAME_SIZE]") ByteBuffer value) { XrApplicationInfo.nengineName(address(), value); return this; }
        /** Sets the specified value to the {@code engineVersion} field. */
        public Buffer engineVersion(@NativeType("uint32_t") int value) { XrApplicationInfo.nengineVersion(address(), value); return this; }
        /** Sets the specified value to the {@code apiVersion} field. */
        public Buffer apiVersion(@NativeType("XrVersion") long value) { XrApplicationInfo.napiVersion(address(), value); return this; }
