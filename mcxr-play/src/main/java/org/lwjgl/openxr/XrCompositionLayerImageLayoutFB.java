...
public class XrCompositionLayerImageLayoutFB extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrCompositionLayerImageLayoutFB, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrCompositionLayerImageLayoutFB.ntype(address(), value); return this; }
        /** Sets the {@link FBCompositionLayerImageLayout#XR_TYPE_COMPOSITION_LAYER_IMAGE_LAYOUT_FB TYPE_COMPOSITION_LAYER_IMAGE_LAYOUT_FB} value to the {@code type} field. */
        public Buffer type$Default() { return type(FBCompositionLayerImageLayout.XR_TYPE_COMPOSITION_LAYER_IMAGE_LAYOUT_FB); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void *") long value) { XrCompositionLayerImageLayoutFB.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("XrCompositionLayerImageLayoutFlagsFB") long value) { XrCompositionLayerImageLayoutFB.nflags(address(), value); return this; }
