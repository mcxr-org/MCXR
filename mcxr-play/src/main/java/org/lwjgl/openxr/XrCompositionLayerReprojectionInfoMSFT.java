...
public class XrCompositionLayerReprojectionInfoMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrCompositionLayerReprojectionInfoMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrCompositionLayerReprojectionInfoMSFT.ntype(address(), value); return this; }
        /** Sets the {@link MSFTCompositionLayerReprojection#XR_TYPE_COMPOSITION_LAYER_REPROJECTION_INFO_MSFT TYPE_COMPOSITION_LAYER_REPROJECTION_INFO_MSFT} value to the {@code type} field. */
        public Buffer type$Default() { return type(MSFTCompositionLayerReprojection.XR_TYPE_COMPOSITION_LAYER_REPROJECTION_INFO_MSFT); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrCompositionLayerReprojectionInfoMSFT.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code reprojectionMode} field. */
        public Buffer reprojectionMode(@NativeType("XrReprojectionModeMSFT") int value) { XrCompositionLayerReprojectionInfoMSFT.nreprojectionMode(address(), value); return this; }
