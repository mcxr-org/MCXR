...
public class XrDebugUtilsMessengerCallbackDataEXT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrDebugUtilsMessengerCallbackDataEXT, Buffer> implements NativeResource {
        ...
        /** Sets the address of the specified encoded string to the {@code messageId} field. */
        public Buffer messageId(@NativeType("char const *") ByteBuffer value) { XrDebugUtilsMessengerCallbackDataEXT.nmessageId(address(), value); return this; }
        /** Sets the address of the specified encoded string to the {@code functionName} field. */
        public Buffer functionName(@NativeType("char const *") ByteBuffer value) { XrDebugUtilsMessengerCallbackDataEXT.nfunctionName(address(), value); return this; }
        /** Sets the address of the specified encoded string to the {@code message} field. */
        public Buffer message(@NativeType("char const *") ByteBuffer value) { XrDebugUtilsMessengerCallbackDataEXT.nmessage(address(), value); return this; }
        /** Sets the specified value to the {@code objectCount} field. */
        public Buffer objectCount(@NativeType("uint32_t") int value) { XrDebugUtilsMessengerCallbackDataEXT.nobjectCount(address(), value); return this; }
        /** Sets the address of the specified {@link XrDebugUtilsObjectNameInfoEXT.Buffer} to the {@code objects} field. */
        public Buffer objects(@Nullable @NativeType("XrDebugUtilsObjectNameInfoEXT *") XrDebugUtilsObjectNameInfoEXT.Buffer value) { XrDebugUtilsMessengerCallbackDataEXT.nobjects(address(), value); return this; }
        /** Sets the specified value to the {@code sessionLabelCount} field. */
        public Buffer sessionLabelCount(@NativeType("uint32_t") int value) { XrDebugUtilsMessengerCallbackDataEXT.nsessionLabelCount(address(), value); return this; }
        /** Sets the address of the specified {@link XrDebugUtilsLabelEXT.Buffer} to the {@code sessionLabels} field. */
        public Buffer sessionLabels(@Nullable @NativeType("XrDebugUtilsLabelEXT *") XrDebugUtilsLabelEXT.Buffer value) { XrDebugUtilsMessengerCallbackDataEXT.nsessionLabels(address(), value); return this; }
