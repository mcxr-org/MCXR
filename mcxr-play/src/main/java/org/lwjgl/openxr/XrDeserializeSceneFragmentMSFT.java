...
public class XrDeserializeSceneFragmentMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrDeserializeSceneFragmentMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code bufferSize} field. */
        public Buffer bufferSize(@NativeType("uint32_t") int value) { XrDeserializeSceneFragmentMSFT.nbufferSize(address(), value); return this; }
        /** Sets the address of the specified {@link ByteBuffer} to the {@code buffer} field. */
        public Buffer buffer(@Nullable @NativeType("uint8_t const *") ByteBuffer value) { XrDeserializeSceneFragmentMSFT.nbuffer(address(), value); return this; }
