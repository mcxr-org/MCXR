...
public class XrEventDataPerfSettingsEXT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrEventDataPerfSettingsEXT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code domain} field. */
        public Buffer domain(@NativeType("XrPerfSettingsDomainEXT") int value) { XrEventDataPerfSettingsEXT.ndomain(address(), value); return this; }
        /** Sets the specified value to the {@code subDomain} field. */
        public Buffer subDomain(@NativeType("XrPerfSettingsSubDomainEXT") int value) { XrEventDataPerfSettingsEXT.nsubDomain(address(), value); return this; }
        /** Sets the specified value to the {@code fromLevel} field. */
        public Buffer fromLevel(@NativeType("XrPerfSettingsNotificationLevelEXT") int value) { XrEventDataPerfSettingsEXT.nfromLevel(address(), value); return this; }
        /** Sets the specified value to the {@code toLevel} field. */
        public Buffer toLevel(@NativeType("XrPerfSettingsNotificationLevelEXT") int value) { XrEventDataPerfSettingsEXT.ntoLevel(address(), value); return this; }
