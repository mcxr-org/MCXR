...
public class XrEventDataReferenceSpaceChangePending extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrEventDataReferenceSpaceChangePending, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code session} field. */
        public Buffer session(XrSession value) { XrEventDataReferenceSpaceChangePending.nsession(address(), value); return this; }
        /** Sets the specified value to the {@code referenceSpaceType} field. */
        public Buffer referenceSpaceType(@NativeType("XrReferenceSpaceType") int value) { XrEventDataReferenceSpaceChangePending.nreferenceSpaceType(address(), value); return this; }
        /** Sets the specified value to the {@code changeTime} field. */
        public Buffer changeTime(@NativeType("XrTime") long value) { XrEventDataReferenceSpaceChangePending.nchangeTime(address(), value); return this; }
        /** Sets the specified value to the {@code poseValid} field. */
        public Buffer poseValid(@NativeType("XrBool32") boolean value) { XrEventDataReferenceSpaceChangePending.nposeValid(address(), value ? 1 : 0); return this; }
        /** Copies the specified {@link XrPosef} to the {@code poseInPreviousSpace} field. */
        public Buffer poseInPreviousSpace(XrPosef value) { XrEventDataReferenceSpaceChangePending.nposeInPreviousSpace(address(), value); return this; }
        /** Passes the {@code poseInPreviousSpace} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer poseInPreviousSpace(java.util.function.Consumer<XrPosef> consumer) { consumer.accept(poseInPreviousSpace()); return this; }
