...
public class XrEventDataSessionStateChanged extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrEventDataSessionStateChanged, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code session} field. */
        public Buffer session(XrSession value) { XrEventDataSessionStateChanged.nsession(address(), value); return this; }
        /** Sets the specified value to the {@code state} field. */
        public Buffer state(@NativeType("XrSessionState") int value) { XrEventDataSessionStateChanged.nstate(address(), value); return this; }
        /** Sets the specified value to the {@code time} field. */
        public Buffer time(@NativeType("XrTime") long value) { XrEventDataSessionStateChanged.ntime(address(), value); return this; }
