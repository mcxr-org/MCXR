...
public class XrEventDataVisibilityMaskChangedKHR extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrEventDataVisibilityMaskChangedKHR, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code session} field. */
        public Buffer session(XrSession value) { XrEventDataVisibilityMaskChangedKHR.nsession(address(), value); return this; }
        /** Sets the specified value to the {@code viewConfigurationType} field. */
        public Buffer viewConfigurationType(@NativeType("XrViewConfigurationType") int value) { XrEventDataVisibilityMaskChangedKHR.nviewConfigurationType(address(), value); return this; }
        /** Sets the specified value to the {@code viewIndex} field. */
        public Buffer viewIndex(@NativeType("uint32_t") int value) { XrEventDataVisibilityMaskChangedKHR.nviewIndex(address(), value); return this; }
