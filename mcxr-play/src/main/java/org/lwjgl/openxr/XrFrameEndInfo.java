...
public class XrFrameEndInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrFrameEndInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrFrameEndInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_FRAME_END_INFO TYPE_FRAME_END_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_FRAME_END_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrFrameEndInfo.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code displayTime} field. */
        public Buffer displayTime(@NativeType("XrTime") long value) { XrFrameEndInfo.ndisplayTime(address(), value); return this; }
        /** Sets the specified value to the {@code environmentBlendMode} field. */
        public Buffer environmentBlendMode(@NativeType("XrEnvironmentBlendMode") int value) { XrFrameEndInfo.nenvironmentBlendMode(address(), value); return this; }
        /** Sets the specified value to the {@code layerCount} field. */
        public Buffer layerCount(@NativeType("uint32_t") int value) { XrFrameEndInfo.nlayerCount(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@code layers} field. */
        public Buffer layers(@Nullable @NativeType("XrCompositionLayerBaseHeader const * const *") PointerBuffer value) { XrFrameEndInfo.nlayers(address(), value); return this; }
