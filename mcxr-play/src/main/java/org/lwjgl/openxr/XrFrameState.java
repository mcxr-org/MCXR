...
public class XrFrameState extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrFrameState, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code predictedDisplayTime} field. */
        public Buffer predictedDisplayTime(@NativeType("XrTime") long value) { XrFrameState.npredictedDisplayTime(address(), value); return this; }
        /** Sets the specified value to the {@code predictedDisplayPeriod} field. */
        public Buffer predictedDisplayPeriod(@NativeType("XrDuration") long value) { XrFrameState.npredictedDisplayPeriod(address(), value); return this; }
        /** Sets the specified value to the {@code shouldRender} field. */
        public Buffer shouldRender(@NativeType("XrBool32") boolean value) { XrFrameState.nshouldRender(address(), value ? 1 : 0); return this; }
