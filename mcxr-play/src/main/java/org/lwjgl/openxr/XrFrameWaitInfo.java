...
public class XrFrameWaitInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrFrameWaitInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrFrameWaitInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_FRAME_WAIT_INFO TYPE_FRAME_WAIT_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_FRAME_WAIT_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrFrameWaitInfo.nnext(address(), value); return this; }
