...
public class XrGraphicsBindingOpenGLWaylandKHR extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrGraphicsBindingOpenGLWaylandKHR, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrGraphicsBindingOpenGLWaylandKHR.ntype(address(), value); return this; }
        /** Sets the {@link KHROpenglEnable#XR_TYPE_GRAPHICS_BINDING_OPENGL_WAYLAND_KHR TYPE_GRAPHICS_BINDING_OPENGL_WAYLAND_KHR} value to the {@code type} field. */
        public Buffer type$Default() { return type(KHROpenglEnable.XR_TYPE_GRAPHICS_BINDING_OPENGL_WAYLAND_KHR); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrGraphicsBindingOpenGLWaylandKHR.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code display} field. */
        public Buffer display(@NativeType("struct wl_display *") long value) { XrGraphicsBindingOpenGLWaylandKHR.ndisplay(address(), value); return this; }
