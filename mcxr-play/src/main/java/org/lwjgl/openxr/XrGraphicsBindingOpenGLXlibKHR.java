...
public class XrGraphicsBindingOpenGLXlibKHR extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrGraphicsBindingOpenGLXlibKHR, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code xDisplay} field. */
        public Buffer xDisplay(@NativeType("Display *") long value) { XrGraphicsBindingOpenGLXlibKHR.nxDisplay(address(), value); return this; }
        /** Sets the specified value to the {@code visualid} field. */
        public Buffer visualid(@NativeType("uint32_t") int value) { XrGraphicsBindingOpenGLXlibKHR.nvisualid(address(), value); return this; }
        /** Sets the specified value to the {@code glxFBConfig} field. */
        public Buffer glxFBConfig(@NativeType("GLXFBConfig") long value) { XrGraphicsBindingOpenGLXlibKHR.nglxFBConfig(address(), value); return this; }
        /** Sets the specified value to the {@code glxDrawable} field. */
        public Buffer glxDrawable(@NativeType("GLXDrawable") long value) { XrGraphicsBindingOpenGLXlibKHR.nglxDrawable(address(), value); return this; }
        /** Sets the specified value to the {@code glxContext} field. */
        public Buffer glxContext(@NativeType("GLXContext") long value) { XrGraphicsBindingOpenGLXlibKHR.nglxContext(address(), value); return this; }
