...
public class XrInstanceCreateInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrInstanceCreateInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code createFlags} field. */
        public Buffer createFlags(@NativeType("XrInstanceCreateFlags") long value) { XrInstanceCreateInfo.ncreateFlags(address(), value); return this; }
        /** Copies the specified {@link XrApplicationInfo} to the {@code applicationInfo} field. */
        public Buffer applicationInfo(XrApplicationInfo value) { XrInstanceCreateInfo.napplicationInfo(address(), value); return this; }
        /** Passes the {@code applicationInfo} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer applicationInfo(java.util.function.Consumer<XrApplicationInfo> consumer) { consumer.accept(applicationInfo()); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@code enabledApiLayerNames} field. */
        public Buffer enabledApiLayerNames(@Nullable @NativeType("char const * const *") PointerBuffer value) { XrInstanceCreateInfo.nenabledApiLayerNames(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@code enabledExtensionNames} field. */
        public Buffer enabledExtensionNames(@Nullable @NativeType("char const * const *") PointerBuffer value) { XrInstanceCreateInfo.nenabledExtensionNames(address(), value); return this; }
