...
public class XrOffset2Di extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrOffset2Di, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(@NativeType("int32_t") int value) { XrOffset2Di.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(@NativeType("int32_t") int value) { XrOffset2Di.ny(address(), value); return this; }
