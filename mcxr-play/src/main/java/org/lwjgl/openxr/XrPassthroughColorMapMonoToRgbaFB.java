...
import static org.lwjgl.openxr.FBPassthrough.XR_PASSTHROUGH_COLOR_MAP_MONO_SIZE_FB;
...
public class XrPassthroughColorMapMonoToRgbaFB extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrPassthroughColorMapMonoToRgbaFB, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrPassthroughColorMapMonoToRgbaFB.ntype(address(), value); return this; }
        /** Sets the {@link FBPassthrough#XR_TYPE_PASSTHROUGH_COLOR_MAP_MONO_TO_RGBA_FB TYPE_PASSTHROUGH_COLOR_MAP_MONO_TO_RGBA_FB} value to the {@code type} field. */
        public Buffer type$Default() { return type(FBPassthrough.XR_TYPE_PASSTHROUGH_COLOR_MAP_MONO_TO_RGBA_FB); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrPassthroughColorMapMonoToRgbaFB.nnext(address(), value); return this; }
        /** Copies the specified {@link XrColor4f.Buffer} to the {@code textureColorMap} field. */
        public Buffer textureColorMap(@NativeType("XrColor4f[XR_PASSTHROUGH_COLOR_MAP_MONO_SIZE_FB]") XrColor4f.Buffer value) { XrPassthroughColorMapMonoToRgbaFB.ntextureColorMap(address(), value); return this; }
        /** Copies the specified {@link XrColor4f} at the specified index of the {@code textureColorMap} field. */
        public Buffer textureColorMap(int index, XrColor4f value) { XrPassthroughColorMapMonoToRgbaFB.ntextureColorMap(address(), index, value); return this; }
        /** Passes the {@code textureColorMap} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer textureColorMap(java.util.function.Consumer<XrColor4f.Buffer> consumer) { consumer.accept(textureColorMap()); return this; }
        /** Passes the element at {@code index} of the {@code textureColorMap} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer textureColorMap(int index, java.util.function.Consumer<XrColor4f> consumer) { consumer.accept(textureColorMap(index)); return this; }
