...
public class XrPosef extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrPosef, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link XrQuaternionf} to the {@code orientation} field. */
        public Buffer orientation(XrQuaternionf value) { XrPosef.norientation(address(), value); return this; }
        /** Passes the {@code orientation} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer orientation(java.util.function.Consumer<XrQuaternionf> consumer) { consumer.accept(orientation()); return this; }
        /** Copies the specified {@link XrVector3f} to the {@code position} field. */
        public Buffer position$(XrVector3f value) { XrPosef.nposition$(address(), value); return this; }
        /** Passes the {@code position} field to the specified {@link java.util.function.Consumer Consumer}. */
