...
public class XrQuaternionf extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrQuaternionf} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrQuaternionf mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrQuaternionf} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrQuaternionf callocStack() {
     ...
     */
    public static XrQuaternionf mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrQuaternionf callocStack(MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<XrQuaternionf, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(float value) { XrQuaternionf.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(float value) { XrQuaternionf.ny(address(), value); return this; }
        /** Sets the specified value to the {@code z} field. */
        public Buffer z(float value) { XrQuaternionf.nz(address(), value); return this; }
        /** Sets the specified value to the {@code w} field. */
        public Buffer w(float value) { XrQuaternionf.nw(address(), value); return this; }
