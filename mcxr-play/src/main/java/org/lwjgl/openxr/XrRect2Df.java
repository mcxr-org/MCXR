...
public class XrRect2Df extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrRect2Df, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link XrOffset2Df} to the {@code offset} field. */
        public Buffer offset(XrOffset2Df value) { XrRect2Df.noffset(address(), value); return this; }
        /** Passes the {@code offset} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer offset(java.util.function.Consumer<XrOffset2Df> consumer) { consumer.accept(offset()); return this; }
        /** Copies the specified {@link XrExtent2Df} to the {@code extent} field. */
        public Buffer extent(XrExtent2Df value) { XrRect2Df.nextent(address(), value); return this; }
        /** Passes the {@code extent} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer extent(java.util.function.Consumer<XrExtent2Df> consumer) { consumer.accept(extent()); return this; }
