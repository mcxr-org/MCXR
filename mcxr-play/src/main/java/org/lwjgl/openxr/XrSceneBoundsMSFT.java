...
public class XrSceneBoundsMSFT extends Struct implements NativeResource {
    ...
    /** @return the value of the {@code sphereCount} field. */
    @NativeType("uint32_t")
    public int sphereCount() { return nsphereCount(address()); }
    /** @return a {@link XrSceneSphereBoundMSFT.Buffer} view of the struct array pointed to by the {@code spheres} field. */
    @Nullable
    @NativeType("XrSceneSphereBoundMSFT const *")
    public XrSceneSphereBoundMSFT.Buffer spheres() { return nspheres(address()); }
    /** @return the value of the {@code boxCount} field. */
    @NativeType("uint32_t")
    public int boxCount() { return nboxCount(address()); }
    /** @return a {@link XrSceneOrientedBoxBoundMSFT.Buffer} view of the struct array pointed to by the {@code boxes} field. */
    @Nullable
    @NativeType("XrSceneOrientedBoxBoundMSFT const *")
    public XrSceneOrientedBoxBoundMSFT.Buffer boxes() { return nboxes(address()); }
    /** @return the value of the {@code frustumCount} field. */
    @NativeType("uint32_t")
    public int frustumCount() { return nfrustumCount(address()); }
    /** @return a {@link XrSceneFrustumBoundMSFT.Buffer} view of the struct array pointed to by the {@code frustums} field. */
    @Nullable
    ...
    /** Sets the specified value to the {@code sphereCount} field. */
    public XrSceneBoundsMSFT sphereCount(@NativeType("uint32_t") int value) { nsphereCount(address(), value); return this; }
    /** Sets the address of the specified {@link XrSceneSphereBoundMSFT.Buffer} to the {@code spheres} field. */
    ...
    /** Sets the specified value to the {@code boxCount} field. */
    public XrSceneBoundsMSFT boxCount(@NativeType("uint32_t") int value) { nboxCount(address(), value); return this; }
    /** Sets the address of the specified {@link XrSceneOrientedBoxBoundMSFT.Buffer} to the {@code boxes} field. */
    ...
    /** Sets the specified value to the {@code frustumCount} field. */
    public XrSceneBoundsMSFT frustumCount(@NativeType("uint32_t") int value) { nfrustumCount(address(), value); return this; }
    /** Sets the address of the specified {@link XrSceneFrustumBoundMSFT.Buffer} to the {@code frustums} field. */
    ...
    public static class Buffer extends StructBuffer<XrSceneBoundsMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code space} field. */
        public Buffer space(XrSpace value) { XrSceneBoundsMSFT.nspace(address(), value); return this; }
        /** Sets the specified value to the {@code time} field. */
        public Buffer time(@NativeType("XrTime") long value) { XrSceneBoundsMSFT.ntime(address(), value); return this; }
        /** Sets the specified value to the {@code sphereCount} field. */
        public Buffer sphereCount(@NativeType("uint32_t") int value) { XrSceneBoundsMSFT.nsphereCount(address(), value); return this; }
        /** Sets the address of the specified {@link XrSceneSphereBoundMSFT.Buffer} to the {@code spheres} field. */
        public Buffer spheres(@Nullable @NativeType("XrSceneSphereBoundMSFT const *") XrSceneSphereBoundMSFT.Buffer value) { XrSceneBoundsMSFT.nspheres(address(), value); return this; }
        /** Sets the specified value to the {@code boxCount} field. */
        public Buffer boxCount(@NativeType("uint32_t") int value) { XrSceneBoundsMSFT.nboxCount(address(), value); return this; }
        /** Sets the address of the specified {@link XrSceneOrientedBoxBoundMSFT.Buffer} to the {@code boxes} field. */
        public Buffer boxes(@Nullable @NativeType("XrSceneOrientedBoxBoundMSFT const *") XrSceneOrientedBoxBoundMSFT.Buffer value) { XrSceneBoundsMSFT.nboxes(address(), value); return this; }
        /** Sets the specified value to the {@code frustumCount} field. */
        public Buffer frustumCount(@NativeType("uint32_t") int value) { XrSceneBoundsMSFT.nfrustumCount(address(), value); return this; }
        /** Sets the address of the specified {@link XrSceneFrustumBoundMSFT.Buffer} to the {@code frustums} field. */
        public Buffer frustums(@Nullable @NativeType("XrSceneFrustumBoundMSFT const *") XrSceneFrustumBoundMSFT.Buffer value) { XrSceneBoundsMSFT.nfrustums(address(), value); return this; }
