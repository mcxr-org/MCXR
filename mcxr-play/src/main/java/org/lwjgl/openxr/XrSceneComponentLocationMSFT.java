...
public class XrSceneComponentLocationMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSceneComponentLocationMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code flags} field. */
        public Buffer flags(@NativeType("XrSpaceLocationFlags") long value) { XrSceneComponentLocationMSFT.nflags(address(), value); return this; }
        /** Copies the specified {@link XrPosef} to the {@code pose} field. */
        public Buffer pose(XrPosef value) { XrSceneComponentLocationMSFT.npose(address(), value); return this; }
        /** Passes the {@code pose} field to the specified {@link java.util.function.Consumer Consumer}. */
