...
public class XrSceneComponentMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSceneComponentMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code componentType} field. */
        public Buffer componentType(@NativeType("XrSceneComponentTypeMSFT") int value) { XrSceneComponentMSFT.ncomponentType(address(), value); return this; }
        /** Copies the specified {@link XrUuidMSFT} to the {@code id} field. */
        public Buffer id(XrUuidMSFT value) { XrSceneComponentMSFT.nid(address(), value); return this; }
        /** Passes the {@code id} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer id(java.util.function.Consumer<XrUuidMSFT> consumer) { consumer.accept(id()); return this; }
        /** Copies the specified {@link XrUuidMSFT} to the {@code parentId} field. */
        public Buffer parentId(XrUuidMSFT value) { XrSceneComponentMSFT.nparentId(address(), value); return this; }
        /** Passes the {@code parentId} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer parentId(java.util.function.Consumer<XrUuidMSFT> consumer) { consumer.accept(parentId()); return this; }
        /** Sets the specified value to the {@code updateTime} field. */
        public Buffer updateTime(@NativeType("XrTime") long value) { XrSceneComponentMSFT.nupdateTime(address(), value); return this; }
