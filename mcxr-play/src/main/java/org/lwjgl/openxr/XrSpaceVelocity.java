...
public class XrSpaceVelocity extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSpaceVelocity, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrSpaceVelocity.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_SPACE_VELOCITY TYPE_SPACE_VELOCITY} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_SPACE_VELOCITY); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void *") long value) { XrSpaceVelocity.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code velocityFlags} field. */
        public Buffer velocityFlags(@NativeType("XrSpaceVelocityFlags") long value) { XrSpaceVelocity.nvelocityFlags(address(), value); return this; }
        /** Copies the specified {@link XrVector3f} to the {@code linearVelocity} field. */
        public Buffer linearVelocity(XrVector3f value) { XrSpaceVelocity.nlinearVelocity(address(), value); return this; }
        /** Passes the {@code linearVelocity} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer linearVelocity(java.util.function.Consumer<XrVector3f> consumer) { consumer.accept(linearVelocity()); return this; }
        /** Copies the specified {@link XrVector3f} to the {@code angularVelocity} field. */
        public Buffer angularVelocity(XrVector3f value) { XrSpaceVelocity.nangularVelocity(address(), value); return this; }
        /** Passes the {@code angularVelocity} field to the specified {@link java.util.function.Consumer Consumer}. */
