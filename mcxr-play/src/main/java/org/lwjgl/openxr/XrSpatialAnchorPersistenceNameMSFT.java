...
import static org.lwjgl.openxr.MSFTSpatialAnchorPersistence.XR_MAX_SPATIAL_ANCHOR_NAME_SIZE_MSFT;
...
public class XrSpatialAnchorPersistenceNameMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSpatialAnchorPersistenceNameMSFT, Buffer> implements NativeResource {
        ...
        /** Copies the specified encoded string to the {@code name} field. */
        public Buffer name(@NativeType("char[XR_MAX_SPATIAL_ANCHOR_NAME_SIZE_MSFT]") ByteBuffer value) { XrSpatialAnchorPersistenceNameMSFT.nname(address(), value); return this; }
