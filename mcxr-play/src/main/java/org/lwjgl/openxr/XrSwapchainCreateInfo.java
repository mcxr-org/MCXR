...
public class XrSwapchainCreateInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSwapchainCreateInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code createFlags} field. */
        public Buffer createFlags(@NativeType("XrSwapchainCreateFlags") long value) { XrSwapchainCreateInfo.ncreateFlags(address(), value); return this; }
        /** Sets the specified value to the {@code usageFlags} field. */
        public Buffer usageFlags(@NativeType("XrSwapchainUsageFlags") long value) { XrSwapchainCreateInfo.nusageFlags(address(), value); return this; }
        /** Sets the specified value to the {@code format} field. */
        public Buffer format(@NativeType("int64_t") long value) { XrSwapchainCreateInfo.nformat(address(), value); return this; }
        /** Sets the specified value to the {@code sampleCount} field. */
        public Buffer sampleCount(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.nsampleCount(address(), value); return this; }
        /** Sets the specified value to the {@code width} field. */
        public Buffer width(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.nwidth(address(), value); return this; }
        /** Sets the specified value to the {@code height} field. */
        public Buffer height(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.nheight(address(), value); return this; }
        /** Sets the specified value to the {@code faceCount} field. */
        public Buffer faceCount(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.nfaceCount(address(), value); return this; }
        /** Sets the specified value to the {@code arraySize} field. */
        public Buffer arraySize(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.narraySize(address(), value); return this; }
        /** Sets the specified value to the {@code mipCount} field. */
        public Buffer mipCount(@NativeType("uint32_t") int value) { XrSwapchainCreateInfo.nmipCount(address(), value); return this; }
