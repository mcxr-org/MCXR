...
public class XrSwapchainImageReleaseInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSwapchainImageReleaseInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrSwapchainImageReleaseInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_SWAPCHAIN_IMAGE_RELEASE_INFO TYPE_SWAPCHAIN_IMAGE_RELEASE_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_SWAPCHAIN_IMAGE_RELEASE_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrSwapchainImageReleaseInfo.nnext(address(), value); return this; }
