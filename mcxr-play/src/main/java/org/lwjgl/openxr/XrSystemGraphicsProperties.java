...
public class XrSystemGraphicsProperties extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSystemGraphicsProperties, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code maxSwapchainImageHeight} field. */
        public Buffer maxSwapchainImageHeight(@NativeType("uint32_t") int value) { XrSystemGraphicsProperties.nmaxSwapchainImageHeight(address(), value); return this; }
        /** Sets the specified value to the {@code maxSwapchainImageWidth} field. */
        public Buffer maxSwapchainImageWidth(@NativeType("uint32_t") int value) { XrSystemGraphicsProperties.nmaxSwapchainImageWidth(address(), value); return this; }
        /** Sets the specified value to the {@code maxLayerCount} field. */
        public Buffer maxLayerCount(@NativeType("uint32_t") int value) { XrSystemGraphicsProperties.nmaxLayerCount(address(), value); return this; }
