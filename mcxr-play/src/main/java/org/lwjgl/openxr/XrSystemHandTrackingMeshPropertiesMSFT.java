...
public class XrSystemHandTrackingMeshPropertiesMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSystemHandTrackingMeshPropertiesMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code supportsHandTrackingMesh} field. */
        public Buffer supportsHandTrackingMesh(@NativeType("XrBool32") boolean value) { XrSystemHandTrackingMeshPropertiesMSFT.nsupportsHandTrackingMesh(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@code maxHandMeshIndexCount} field. */
        public Buffer maxHandMeshIndexCount(@NativeType("uint32_t") int value) { XrSystemHandTrackingMeshPropertiesMSFT.nmaxHandMeshIndexCount(address(), value); return this; }
        /** Sets the specified value to the {@code maxHandMeshVertexCount} field. */
        public Buffer maxHandMeshVertexCount(@NativeType("uint32_t") int value) { XrSystemHandTrackingMeshPropertiesMSFT.nmaxHandMeshVertexCount(address(), value); return this; }
