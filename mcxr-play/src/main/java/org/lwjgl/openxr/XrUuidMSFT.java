...
public class XrUuidMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrUuidMSFT, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link ByteBuffer} to the {@code bytes} field. */
        public Buffer bytes(@NativeType("uint8_t[16]") ByteBuffer value) { XrUuidMSFT.nbytes(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code bytes} field. */
        public Buffer bytes(int index, @NativeType("uint8_t") byte value) { XrUuidMSFT.nbytes(address(), index, value); return this; }
