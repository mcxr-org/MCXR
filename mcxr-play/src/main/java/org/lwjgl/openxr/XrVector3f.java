...
public class XrVector3f extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrVector3f, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(float value) { XrVector3f.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(float value) { XrVector3f.ny(address(), value); return this; }
        /** Sets the specified value to the {@code z} field. */
        public Buffer z(float value) { XrVector3f.nz(address(), value); return this; }
