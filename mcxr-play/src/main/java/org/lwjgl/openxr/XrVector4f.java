...
public class XrVector4f extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrVector4f, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(float value) { XrVector4f.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(float value) { XrVector4f.ny(address(), value); return this; }
        /** Sets the specified value to the {@code z} field. */
        public Buffer z(float value) { XrVector4f.nz(address(), value); return this; }
        /** Sets the specified value to the {@code w} field. */
        public Buffer w(float value) { XrVector4f.nw(address(), value); return this; }
