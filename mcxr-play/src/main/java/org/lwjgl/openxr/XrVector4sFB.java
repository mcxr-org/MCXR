...
public class XrVector4sFB extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrVector4sFB, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(@NativeType("int16_t") short value) { XrVector4sFB.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(@NativeType("int16_t") short value) { XrVector4sFB.ny(address(), value); return this; }
        /** Sets the specified value to the {@code z} field. */
        public Buffer z(@NativeType("int16_t") short value) { XrVector4sFB.nz(address(), value); return this; }
        /** Sets the specified value to the {@code w} field. */
        public Buffer w(@NativeType("int16_t") short value) { XrVector4sFB.nw(address(), value); return this; }
