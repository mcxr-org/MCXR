...
public class XrViewConfigurationView extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrViewConfigurationView, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code recommendedImageRectWidth} field. */
        public Buffer recommendedImageRectWidth(@NativeType("uint32_t") int value) { XrViewConfigurationView.nrecommendedImageRectWidth(address(), value); return this; }
        /** Sets the specified value to the {@code maxImageRectWidth} field. */
        public Buffer maxImageRectWidth(@NativeType("uint32_t") int value) { XrViewConfigurationView.nmaxImageRectWidth(address(), value); return this; }
        /** Sets the specified value to the {@code recommendedImageRectHeight} field. */
        public Buffer recommendedImageRectHeight(@NativeType("uint32_t") int value) { XrViewConfigurationView.nrecommendedImageRectHeight(address(), value); return this; }
        /** Sets the specified value to the {@code maxImageRectHeight} field. */
        public Buffer maxImageRectHeight(@NativeType("uint32_t") int value) { XrViewConfigurationView.nmaxImageRectHeight(address(), value); return this; }
        /** Sets the specified value to the {@code recommendedSwapchainSampleCount} field. */
        public Buffer recommendedSwapchainSampleCount(@NativeType("uint32_t") int value) { XrViewConfigurationView.nrecommendedSwapchainSampleCount(address(), value); return this; }
        /** Sets the specified value to the {@code maxSwapchainSampleCount} field. */
        public Buffer maxSwapchainSampleCount(@NativeType("uint32_t") int value) { XrViewConfigurationView.nmaxSwapchainSampleCount(address(), value); return this; }
