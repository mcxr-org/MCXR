...
public class XrViewLocateInfo extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrViewLocateInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrViewLocateInfo.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_VIEW_LOCATE_INFO TYPE_VIEW_LOCATE_INFO} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_VIEW_LOCATE_INFO); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrViewLocateInfo.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code viewConfigurationType} field. */
        public Buffer viewConfigurationType(@NativeType("XrViewConfigurationType") int value) { XrViewLocateInfo.nviewConfigurationType(address(), value); return this; }
        /** Sets the specified value to the {@code displayTime} field. */
        public Buffer displayTime(@NativeType("XrTime") long value) { XrViewLocateInfo.ndisplayTime(address(), value); return this; }
        /** Sets the specified value to the {@code space} field. */
        public Buffer space(XrSpace value) { XrViewLocateInfo.nspace(address(), value); return this; }
