...
public class XrViewState extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrViewState, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrViewState.ntype(address(), value); return this; }
        /** Sets the {@link XR10#XR_TYPE_VIEW_STATE TYPE_VIEW_STATE} value to the {@code type} field. */
        public Buffer type$Default() { return type(XR10.XR_TYPE_VIEW_STATE); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void *") long value) { XrViewState.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code viewStateFlags} field. */
        public Buffer viewStateFlags(@NativeType("XrViewStateFlags") long value) { XrViewState.nviewStateFlags(address(), value); return this; }
