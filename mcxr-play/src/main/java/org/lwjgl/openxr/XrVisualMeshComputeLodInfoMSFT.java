...
public class XrVisualMeshComputeLodInfoMSFT extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrVisualMeshComputeLodInfoMSFT, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code type} field. */
        public Buffer type(@NativeType("XrStructureType") int value) { XrVisualMeshComputeLodInfoMSFT.ntype(address(), value); return this; }
        /** Sets the {@link MSFTSceneUnderstanding#XR_TYPE_VISUAL_MESH_COMPUTE_LOD_INFO_MSFT TYPE_VISUAL_MESH_COMPUTE_LOD_INFO_MSFT} value to the {@code type} field. */
        public Buffer type$Default() { return type(MSFTSceneUnderstanding.XR_TYPE_VISUAL_MESH_COMPUTE_LOD_INFO_MSFT); }
        /** Sets the specified value to the {@code next} field. */
        public Buffer next(@NativeType("void const *") long value) { XrVisualMeshComputeLodInfoMSFT.nnext(address(), value); return this; }
        /** Sets the specified value to the {@code lod} field. */
        public Buffer lod(@NativeType("XrMeshComputeLodMSFT") int value) { XrVisualMeshComputeLodInfoMSFT.nlod(address(), value); return this; }
