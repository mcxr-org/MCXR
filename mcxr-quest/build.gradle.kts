...
base {
    archivesBaseName = "mcxr-quest"
}

version = "${properties["quest_version"].toString()}+mc${properties["minecraft_version"].toString()}"
...
tasks {
    processResources {
        val questVersion = project.properties["quest_version"].toString();
        inputs.property("quest_version", questVersion)

        filesMatching("fabric.mod.json") {
            expand("quest_version" to questVersion)
        }
    }
