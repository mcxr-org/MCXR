...
public class XrActionsSyncInfo extends Struct implements NativeResource {
    ...
    /** Sets the address of the specified {@link XrActiveActionSet.Buffer} to the {@code activeActionSets} field. */
    ...
    public static class Buffer extends StructBuffer<XrActionsSyncInfo, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code countActiveActionSets} field. */
        public Buffer countActiveActionSets(@NativeType("uint32_t") int value) { XrActionsSyncInfo.ncountActiveActionSets(address(), value); return this; }
        /** Sets the address of the specified {@link XrActiveActionSet.Buffer} to the {@code activeActionSets} field. */
        public Buffer activeActionSets(@Nullable @NativeType("XrActiveActionSet const *") XrActiveActionSet.Buffer value) { XrActionsSyncInfo.nactiveActionSets(address(), value); return this; }
