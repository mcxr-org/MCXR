...
public class XrGraphicsBindingEGLMNDX extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrGraphicsBindingEGLMNDX, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code getProcAddress} field. */
        public Buffer getProcAddress(@NativeType("PFNEGLGETPROCADDRESSPROC") long value) { XrGraphicsBindingEGLMNDX.ngetProcAddress(address(), value); return this; }
        /** Sets the specified value to the {@code display} field. */
        public Buffer display(@NativeType("EGLDisplay") long value) { XrGraphicsBindingEGLMNDX.ndisplay(address(), value); return this; }
        /** Sets the specified value to the {@code config} field. */
        public Buffer config(@NativeType("EGLConfig") long value) { XrGraphicsBindingEGLMNDX.nconfig(address(), value); return this; }
        /** Sets the specified value to the {@code context} field. */
        public Buffer context(@NativeType("EGLContext") long value) { XrGraphicsBindingEGLMNDX.ncontext(address(), value); return this; }
