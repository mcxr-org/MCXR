...
public class XrSystemTrackingProperties extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<XrSystemTrackingProperties, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code orientationTracking} field. */
        public Buffer orientationTracking(@NativeType("XrBool32") boolean value) { XrSystemTrackingProperties.norientationTracking(address(), value ? 1 : 0); return this; }
        /** Sets the specified value to the {@code positionTracking} field. */
        public Buffer positionTracking(@NativeType("XrBool32") boolean value) { XrSystemTrackingProperties.npositionTracking(address(), value ? 1 : 0); return this; }
