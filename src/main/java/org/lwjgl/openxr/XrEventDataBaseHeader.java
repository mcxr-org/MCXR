...
public class XrEventDataBaseHeader extends Struct implements NativeResource {
    ...
    /** Returns a new {@code XrEventDataBaseHeader} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrEventDataBaseHeader mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrEventDataBaseHeader} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrEventDataBaseHeader callocStack() {
     ...
     */
    public static XrEventDataBaseHeader mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrEventDataBaseHeader callocStack(MemoryStack stack) {
