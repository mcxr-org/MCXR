...
public class XrRect2Di extends Struct implements NativeResource {
    ...
    /** Returns a {@link XrOffset2Di} view of the {@code offset} field. */
    public XrOffset2Di offset() { return noffset(address()); }
    /** Returns a {@link XrExtent2Di} view of the {@code extent} field. */
    ...
    /** Returns a new {@code XrRect2Di} instance allocated on the thread-local {@link MemoryStack}. */
    public static XrRect2Di mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@code XrRect2Di} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static XrRect2Di callocStack() {
     ...
     */
    public static XrRect2Di mallocStack(MemoryStack stack) {
     ...
     * @param stack the stack from which to allocate
     */
    public static XrRect2Di callocStack(MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<XrRect2Di, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link XrOffset2Di} to the {@code offset} field. */
        public Buffer offset(XrOffset2Di value) { XrRect2Di.noffset(address(), value); return this; }
        /** Passes the {@code offset} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer offset(java.util.function.Consumer<XrOffset2Di> consumer) { consumer.accept(offset()); return this; }
        /** Copies the specified {@link XrExtent2Di} to the {@code extent} field. */
        public Buffer extent(XrExtent2Di value) { XrRect2Di.nextent(address(), value); return this; }
        /** Passes the {@code extent} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer extent(java.util.function.Consumer<XrExtent2Di> consumer) { consumer.accept(extent()); return this; }
